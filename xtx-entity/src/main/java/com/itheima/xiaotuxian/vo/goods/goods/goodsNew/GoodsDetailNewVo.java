...
import com.itheima.xiaotuxian.vo.classification.BackendByLayerListVo;
...
public class GoodsDetailNewVo {
     ...
     * 所属分类信息
     */
    private List<BackendByLayerListVo> backend;
