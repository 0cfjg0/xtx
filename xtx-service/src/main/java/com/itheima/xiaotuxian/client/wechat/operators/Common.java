...
import com.itheima.xiaotuxian.client.wechat.response.CloseResponse;
...
public class Common {
    ...
    public QueryResponse query(String outTradeNo) throws Exception {
        ...
        if (StringUtils.isNotBlank(queryResponse.getTradeState())){
            queryResponse.setCode("200");
            queryResponse.setMessage("请求成功");
        }
    ...
    public RefundResponse queryRefund(String outRefundNo) throws Exception {
        ...
        if (StringUtils.isNotBlank(refundResponse.getStatus())){
            refundResponse.setCode("200");
            refundResponse.setMessage("请求成功");
        }
    ...
    public CloseResponse close(String outTradeNo) throws Exception {
        ...
        String body =   httpClient.doPost(bodyParams);
        CloseResponse closeResponse = JSONObject.parseObject(body, CloseResponse.class);
        closeResponse.setCode("200");
        closeResponse.setMessage("请求成功");
