...
import com.itheima.xiaotuxian.client.wechat.response.PagePayResponse;
...
public class Page {
    ...
    public PagePayResponse pay(String outTradeNo, String amount,
        ...
        if (StringUtils.isNotBlank(pagePayResponse.getPrepayId())){
            pagePayResponse.setCode("200");
            pagePayResponse.setMessage("请求成功");
